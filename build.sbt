...
libraryDependencies ++= Seq(
  ...
  "org.apache.lucene" % "lucene-analyzers-common" % "6.6.2",
  "org.apache.lucene" % "lucene-analyzers-kuromoji" % "6.6.2",
  "org.apache.lucene" % "lucene-suggest" % "6.6.2",
  "org.apache.lucene" % "lucene-backward-codecs" % "6.6.2",
